...
if [ "$offset" = "0.0" ]; then
   output_name="${outprefix}_${pixels}_${threshold}_${basecfg}${transtype}${extra_suffix}_energy${CORSIKA_EMIN}"
   temp_name="${tempprefix}_${pixels}_${threshold}_${basecfg}${transtype}${extra_suffix}_energy${CORSIKA_EMIN}"

else
   output_name="${outprefix}_${pixels}_${threshold}_${basecfg}${transtype}${extra_suffix}_off${offset}_energy${CORSIKA_EMIN}"
   temp_name="${tempprefix}_${pixels}_${threshold}_${basecfg}${transtype}${extra_suffix}_off${offset}_energy${CORSIKA_EMIN}"
fi
